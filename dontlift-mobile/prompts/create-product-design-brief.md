...
> - **Role:** PRIMARY
> - **Skills:** `$brainstorming` (required: clarify experience trade-offs), `$ui-ux-pro-max` (required: generate design system foundations), `$frontend-expert` (supporting: make states and accessibility concrete)
